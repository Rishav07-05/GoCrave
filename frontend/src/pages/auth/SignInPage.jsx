...
const SignInPage = () => {
  return (
    <div className="min-h-[calc(100vh-64px)] flex">
      ...
      <div className="hidden lg:flex w-1/2 gradient-bg relative items-center justify-center overflow-hidden border-r border-zinc-800/50">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
        ...
        <div className="relative z-10 max-w-lg px-8 text-center">
          ...
          >
            Welcome Back to Go<span className="text-orange-500">Crave</span>
          </motion.h2>
          <motion.p 
          ...
          >
            Sign in to track your live orders, discover new restaurants, and experience the future of food delivery.
          </motion.p>
        </div>
      </div>
